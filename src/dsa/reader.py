...
class DirectoryReader(Reader):
    ...
    def read(self):
        ...
        loader = DirectoryLoader(self.source_folder_path, show_progress=True)
...
class PdfDirectoryReader(Reader):
    ...
    def read(self):
        ...
        loader = PyPDFDirectoryLoader(
            self.source_folder_path, show_progress=True
        )
        loaded_docs = loader.load()
...
class PdfFileReader(FileReader):
    ...
    def read(self):
        ...
        loader = PyPDFLoader(file_path_name_default)
...
class ImageLoader(Reader):
    ...
    def read(self):
        ...
        loader = UnstructuredImageLoader(image_path_name)
